...
# ╔═╡ 9a70c048-2b35-11ee-15dc-f1d1c171ddce
using Plots

# ╔═╡ 838d2702-0ab1-43b7-8244-da878b6160fa
using Flux

# ╔═╡ 16aa5744-a571-49b2-bd1d-16d954634a91
...
# ╔═╡ 409c749d-0e11-4933-aa1c-3acde042c6e6
begin
	n, m = 100, 100
	road, angle = gen_road_angle(n, m)
end

# ╔═╡ 94266e2e-6d14-4ac5-81be-641a10d43e6f
## Reconstruction of the image given the angle and the image size n and m
...
# ╔═╡ e49668f6-2fd9-476a-908b-9c31a6824d0e
generate_image(n, m, angle)

# ╔═╡ 7417f357-8411-4694-8cb9-0bf28fd9f484
...
# ╔═╡ 2416fd0b-3d24-4778-9363-e6f8253f6158
md"""
The model should receive objects: n x m x 1 (only one channel, because the image is in grayscale) x 1 (only one sample). Therefore, the images should be reshaped to a 4D matrix (n, m, 1, 1).
"""

# ╔═╡ 37ff3c17-8d90-4e3d-b19f-736d2aa20269
sample = reshape(Float32.(road), (n, m, 1, 1))

# ╔═╡ d9525387-d741-4049-b74f-fe0e0edefde3
md"""
This is equivalent to:
"""

# ╔═╡ f2005d43-7f43-453c-b11d-471d6c987a54
begin
	sample2 = zeros(n, m, 1, 1)
	for i in 1:n
		for j in 1:m
			sample2[i, j, 1, 1] = Float32(road[i, j])
		end
	end
end

# ╔═╡ d6fe9d0f-f081-4920-bbe3-decfba790283
sample == sample2

# ╔═╡ ae97a0d9-4005-46bf-8945-c6d9758746da
md"""
Evaluation of the model
"""

# ╔═╡ 4641f08c-123d-4a93-87ee-c19a8f87765d
lenet(sample) # the model lenet is not trained yet
